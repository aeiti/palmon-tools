...
export const PALMON_SPECIES = [
  ...
  { key: 'embergeist', name: 'Embergeist', element: 'fire', rarity: 'ur' },
  ...
  { key: 'mammolith', name: 'Mammolith', element: 'earth', rarity: 'ur' },
  ...
  { key: 'thundertooth', name: 'Thundertooth', element: 'electric', rarity: 'ur' },
  ...
  { key: 'zapantis', name: 'Zapantis', element: 'electric', rarity: 'ur' },
];
